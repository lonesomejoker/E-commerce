        ...
        data?.map((item)=>{
          return(
            <div key={item.id} className='my-3'>
              <Card hoverable className='mx-auto text-white bg-black border-none max-w-52 font-varela'>
              <div className='flex justify-start gap-3 py-2 '>
              <img src={item.image} alt="img" className='w-12 h-12 rounded-md '/>
              <section>
              ...
              <button className=' bg-lime-500 w-full rounded-md mt-1 py-1.5
